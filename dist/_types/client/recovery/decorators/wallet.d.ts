...
export declare function zksyncSsoWalletActions<transport extends Transport, chain extends Chain, account extends Account>(client: ClientWithZksyncSsoRecoveryData<transport, chain, account>): ZksyncSsoWalletActions<chain, account>;
